...
describe("fitting step model", () => {
  it("places consent, photo, then name before fit, and ends on verdict", () => {
    ...
    assert.deepEqual(FITTING_Q_STEPS.slice(-3), ["corner", "nolist", "honesty"]);
  ...
  it("maps honesty/verdict to mint, unsewn until asked", () => {
