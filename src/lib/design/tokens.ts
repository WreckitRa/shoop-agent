...
export const tailwindThemeColors = {
  ...
  "surface-muted": colors.surfaceTint,
  hairline: colors.hairline,
  "hairline-soft": colors.hairlineSoft,
  "line-medium": colors.lineMedium,
  success: colors.success,
  "success-soft": colors.successSoft,
  "success-tint": colors.successSoft,
  "success-dark": colors.success,
  warning: colors.warning,
  "warning-soft": colors.warningSoft,
  "warning-tint": colors.warningSoft,
  "warning-dark": colors.warning,
  "warning-emphasis": colors.warning,
  error: colors.brand,
  "error-deep": colors.brandDark,
  "error-bg": colors.brandSoft,
  "error-border": "#F4C7CA",
  "info-bg": colors.surfaceTint,
  "info-accent": colors.inkSecondary,
