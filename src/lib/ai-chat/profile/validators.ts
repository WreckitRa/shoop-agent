...
export const userProfilePatchSchema = z
  .object({
    ...
    climate: z.string().max(240).optional().nullable(),
    ...
    weekIs: z.string().max(240).optional().nullable(),
    dressingFor: z.string().max(240).optional().nullable(),
    weekendsAre: z.string().max(240).optional().nullable(),
    kids: z.string().max(80).optional().nullable(),
